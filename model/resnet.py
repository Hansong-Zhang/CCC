...
from .modules import MetaModule, MetaLinear, MetaConv2d, MetaBatchNorm2d
...
class ResNet(MetaModule):
    def __init__(self, block, num_blocks, num_classes, input_dim):
        super(ResNet, self).__init__()
        self.in_planes = 64
        self.conv1 = MetaConv2d(input_dim, 64, kernel_size=3, stride=1, padding=0, bias=False)
...
def ResNet18(num_classes, in_dim):
    ...
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, in_dim)


def ResNet34(num_classes, in_dim):

    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes, in_dim)


def ResNet50(num_classes, in_dim):

    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, in_dim)


def ResNet101(num_classes, in_dim):

    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes, in_dim)


def ResNet152(num_classes, in_dim):

    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes, in_dim)
